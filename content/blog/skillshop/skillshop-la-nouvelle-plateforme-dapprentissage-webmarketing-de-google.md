---
title: "Skillshop la nouvelle plateforme d'apprentissage Webmarketing de Google"
date: 2019-09-30
author: "admin"
...
## **Programme Google Partner et Plateforme Skillshop**

Petit rappel, depuis fin 2018, la plateforme google Partner n'existe plus. La gestion des badges "google Partner" est intégrée dans la plateforme google ads.

Depuis 2018 également, les équipes de Dublin pour la France, ont animé un programme Fr académie on air dont les vidéos françaises sont animées en Duo par des googlers. Vous y retrouverez tous les sujets sur les principaux thèmes pour gérer les campagnes. Sur YouTube vous y accédez librement ou alors ici sur ce portail dédié : https://events.withgoogle.com/academy-on-air-2019-fr-old/#content
...
Afin de s'aligner sur les types de campagnes Google Ads, le programme Google Partner ne propose plus la spécialisation Publicité mobile. Les spécialisations d'entreprise suivantes sont toujours disponibles : Publicité sur le Réseau de Recherche, Publicité vidéo, Publicité sur le Réseau Display et Publicité avec Google Shopping.

## **Skillshop, centralisation des savoirs sur les produits Google.**

Cette plateforme est ouverte à tous, avec une simple adresse mail, sans avoir pour autant un compte google, mais il est conseillé d'utiliser celle relié à votre compte google existant ou alors d'en créer un pour l'occasion !
...
## **Skillshop Profil et titres de récompense**

Lors d'une inscription à Skillshop, la plateforme délivre des titres de réussite, des certifications selon les parcours et des supports de formation.
...
Les certifications sont délivrées lorsque les évaluations associées sont validées avec les critères de certification associés, soit pour google ads, le minimum de dépenses par spécialisation de 10 000 euros sur 90 jours. Ce sont des accréditations professionnelles que Google accorde aux personnes qui démontrent leur maîtrise des aspects fondamentaux et avancés des produits et solutions Google et qui aboutissent au programme google Partner.

Enfin, notez que la plateforme Google Analytics académie n'est pas intégrée à ce jour dans skillshop. Ce qui veut dire que les évaluations réussies par exemple sur google tag manager ou sur la suite 360 ne sont pas présentes dans le récapitulatif du profil skillshop.
Cette plateforme devient réellement une plateforme d'apprentissage qui s'adapte au profil de son utilisateur. On peut parler d'un outil pédagogique, où la notion d'elearning prend tout son sens. Bon apprentissage !