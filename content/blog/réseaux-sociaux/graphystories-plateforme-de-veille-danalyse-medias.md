---
title: "Graphystories la plateforme de Veille et d'Analyse médias"
date: 2017-11-13
author: "admin"
...
## **Services  de Graphystories**

***Aperçu général de la plateforme ***

Les  4  grands objectifs poursuivis par GraphyStories :

 	- La découverte de contenus

 	- L’analyse des signaux autour de la big data

 	- La veille de contenus concurrentiels
...
Les insights suivants sont donnés :

 	- Reach : la couverture en volume d’abonnées,

 	- Fans : nombre et leur engagement

 	- PtAT : Les personnes qui sont touchés par les contenus médias

 	- Posts : le nombre de post publiés

Il est aussi possible de segmenter les contenus par type :
...
## **Contenus du Web analysés**
 	...
 	- Moyenne X :  performance du contenu par rapport aux articles de ce même contenu

 	- Interactions (sources) : Facebook, Google+, LinkedIn, Pinterest

## **Personnalisation du corpus **

Groupes personnalisés : en dehors des groupes déjà constitués par défaut, il y a possibilités d’ajouter des pages Facebook, des flux, et des sites web de son choix.

### ***Suivre ses propres contenus***
...
Une licence sous forme d’abonnement par utilisateur d’une organisation. Je vous invite à les contacter pour                 avoir une estimation, des prix selon le nombre d’utilisateurs, selon la structure petit ou grande, média ou agence. Pour donner une idée, un minimum de 3 mois est requis, dans le cadre d’un utilisateur, pour un modèle agence web, une licence reviendra à  125 euros / mois.