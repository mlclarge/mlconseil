...
[![Fig.1-Entonnnoir-de-conversion-253x300.png](/images/blog/Fig.1-Entonnnoir-de-conversion-253x300.png) Fig.1 Entonnnoir de conversion
...
[![Fig.2-tunnel-emarketing-multicanal-310x281.png](/images/blog/Fig.2-tunnel-emarketing-multicanal-310x281.png) Fig.2 tunnel-emarketing-multicanal
...
[![fig.3-interface-multicanal-ga-310x248.png](/images/blog/fig.3-interface-multicanal-ga-310x248.png) fig.3 Interface-multicanal-ga
...
[![Fig.4-Conversions-indirectes-1-310x126.png](/images/blog/Fig.4-Conversions-indirectes-1-310x126.png) Fig.4 Conversions indirectes
...
[![Fig.5-Modification-canal-GA-294x300.png](/images/blog/Fig.5-Modification-canal-GA-294x300.png) Fig.5 Modification canal GA
...
[![Fig.6-Chemin-fréquents-ganalytics-310x50.png](/images/blog/Fig.6-Chemin-fréquents-ganalytics-310x50.png) Fig.6-Chemin-fréquents-ganalytics
...
[![Fig.7-Modele-attribution-301x300.png](/images/blog/Fig.7-Modele-attribution-301x300.png) Fig.7 Modele attribution (source Google Analytics)

Ce paramétrage n’est possible que dans la version payante de Google analytics (fig.8).

[![Fig.8-model-attribution-ganalytics-310x163.png](/images/blog/Fig.8-model-attribution-ganalytics-310x163.png) Fig.8 model attribution ganalytics                                            (source havinash KausHik)
