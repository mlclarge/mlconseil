...
[![1-avant-apres-tag-manage-310x260.gif](/images/blog/1-avant-apres-tag-manage-310x260.gif) Fig. 1 Avant & APres le Tag manager

Gtm fournit par défaut le paramétrage de balises dont bien sûr Google analytics.

[![2-balises-tags.gif](/images/blog/2-balises-tags.gif) Fig.2 Les differentes balises (ou tags) dans GTM
...
[![3-container-tag-manager-310x201.gif](/images/blog/3-container-tag-manager-310x201.gif) Fig. 3 Le container a installer sur son site
...
[![4-ga-et-gtm-310x172.png](/images/blog/4-ga-et-gtm-310x172.png) Fig. 4 Installation d'1 balise
...
[![5-balises-ga-310x228.png](/images/blog/5-balises-ga-310x228.png) Fig. 5 Balisage Google Analytics
...
[![6-regles-gtm-230x300.png](/images/blog/6-regles-gtm-230x300.png) Fig. 6 Regles depuis les Macros GTM
...
[![7-macros-gtm-279x300.png](/images/blog/7-macros-gtm-279x300.png) Fig.7 Types de Macros GTM
...
[![8-evenement-310x287.gif](/images/blog/8-evenement-310x287.gif) Fig.8 Evènement dans GA
...
[![9-ecommerce-couche-donnee-310x292.png](/images/blog/9-ecommerce-couche-donnee-310x292.png) Fig. 9 Couche de données pour Tag Ecommerce

2 –Faire autant de macros que de variables dans Tag manager

[![10-ecommerce-macro-1-310x160.png](/images/blog/10-ecommerce-macro-1-310x160.png) Fig. 10 1 des Macros ecommerce (data layer)

3 – Créer ensuite la balise à l’aide d’un « html personnalisé »

[![11-ecommerce-balise-310x202.png](/images/blog/11-ecommerce-balise-310x202.png) Fig.11 Balisage dans GA

4 –Faire une règle pour déclencher la balise.

[![12-ecommerce-regles-310x129.png](/images/blog/12-ecommerce-regles-310x129.png) Fig. 11 Règle Déclenchement balise
