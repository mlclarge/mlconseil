---
title: "Quand Google fait son cinéma !"
date: 2013-07-04
author: "admin"
categories: ["Réflexions numériques"]
tags: []
slug: "quand-google-fait-son-cinema"
---

Un sujet « estival » divertissant dirons-nous en ce début juillet avec la sortie du film "**les stagiaires**"  du cinéaste américain [Shawn Levy](http://www.youtube.com/watch?v=6ICYS9tl3no) *(a qui on doit une Nuit au musée, parmi d’autres)*. Après Facebook (the social network), Apple (jobs), c’est autour de Google !  Je ne ferai pas une critique cinéphilique  mais dresserai un  résumé,   ce qu'il en ressort , et profiterai de l'occasion pour parler de Google et de ses stagiaires, les vrais !
...
Des quadras, commerciaux de profession, licenciés de leur job, tente leur chance chez Google : le défi ? Décrocher un job cdi après un challenge d’équipe. Grosse comédie américaine, nullement militante *(il n’y qu’à voir le casting ;) )*, partisane et sans complexe où défilent comme principales  thématiques celles :
	...
	- De** l’innovation **: Une des premières scènes se déroule au googleplex et montre la voiture "[sans chauffeur](http://fr.wikipedia.org/wiki/Voiture_sans_conducteur_de_Google)".
...
Pour avoir discuté,  lors d’un voyage à [Mountain View l’année dernière](https://www.mauricelargeron.com/resume-du-semaire-google-adwords-2012/), avec des personnes de l’entreprise, même si l’ambiance ressemble à un campus land ludique, la culture de la performance est à l’œuvre.  Mais cela n’est pas spécifique à Google, ni à l’Amérique, souvent caricaturée sur ce propos (anti-américanisme). Le législateur permet en revanche une grande souplesse quant à la flexibilité des ressources humaines. Du jour au lendemain, tu perds ou tu retrouves un job sans procédure juridique. 35000 employés environ et une moyenne d’âge de 31 ans selon un  cabinet RH,  Google n’a que 15 ans d’âge, comment gérer les carrières où la tendance est au recrutement que de jeunes cerveaux ? Pour en savoir plus sur le sujet  ([lien](http://www.cbsnews.com/8301-505125_162-57368586/dark-side-of-social-media-age-discrimination/)).

### **Le Statut des stagiaires**

Les salaires des stagiaires de base seraient de** 5800 dollars**, les plus « ingénieux »  jusqu’à 8 800 $ (selon[ glassdoor](http://www.glassdoor.com/Salary/Google-Salaries-E9079.htm)).  Certes, il y a peu d’élus sur le nombre de candidatures adressées. C'est une moyenne chez les grands de la silicon valley *(MSN, Facebook, LinkedIn)* .
...
[https://www.youtube.com/watch?feature=player_embedded&v=uhmLf2yk-Z4](https://www.youtube.com/watch?feature=player_embedded&v=uhmLf2yk-Z4)

### **Etre Salarié chez Google**

Les conditions d’embauche sont drastiques. 1 Million de candidature par an et seulement 0,5 % d’élus ! 20% du temps travaillé peut être dédié à un projet personnel. En cas de décès, le conjoint se voit octroyer une rente équivalent à la moitié du salaire perçu pendant 10 ans.  Les salaires varient entre 62 000 et 177000 dollars , pour [en savoir plus](http://www.glassdoor.com/Salary/Google-Salaries-E9079.htm).
...
[http://www.youtube.com/watch?v=NSig3_WbezI](http://www.youtube.com/watch?v=NSig3_WbezI)

Si vous êtes tenté par l’appel Américain, rendez-vous sur : [http://www.google.com/intl/en/jobs/students/](http://www.google.com/intl/en/jobs/students/)
