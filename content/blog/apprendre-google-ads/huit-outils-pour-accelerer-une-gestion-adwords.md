---
title: "8 fonctionnalités Adwords pour automatiser ses campagnes"
date: 2012-11-07
author: "admin"
categories: ["Apprendre Google Ads"]
tags: []
slug: "huit-outils-pour-accelerer-une-gestion-adwords"
---

Qu’est il possible d’automatiser dans adwords ? Un sujet donc **transversal** où j’énumère ici quelques outils natifs à la plateforme mais aussi extérieurs à Adwords sans rentrer dans leurs manipulations qui peuvent faire l’objet de plusieurs articles !  Notons pour cette année,  l’incorporation de  2 fonctionnalités importantes : la possibilité d’exécuter des scripts* (sur l’api et  sur google apps)*  et l’optimiseur de conversion pour le réseau de contenu *(display)* . Scoop Adwords teste "béta" des [modifications par lots](http://adwords.blogspot.fr/2012/11/making-large-scale-changes-faster-and.html) des entités de campagnes, cela éviterait donc de recourir à Editor (en espérant que cela n'annonce pas le début de la fin du produit !)

## **Sur la plateforme adwords**

### *Manuellement tout est permis sur Adwords !*
...
[![liste-actifouNon-310x224.png](/images/blog/liste-actifouNon-310x224.png) Fig. 1 Liste à cocher et filtres
...
[![motscles-310x179.png](/images/blog/motscles-310x179.png) Fig. 2 Générateur mots clés
...
[![rotation-annonces-310x146.png](/images/blog/rotation-annonces-310x146.png) Fig. 3 Rotation des annonces
### *Règles automatiques *
...
[![reglesAutimatiques-310x133.png](/images/blog/reglesAutimatiques-310x133.png) Fig .4 Règles automatiques
...
[![scripting-310x190.png](/images/blog/scripting-310x190.png) Fig. 6 Scripting avancés adwords
...
## **En dehors de la plateforme Adwords**

### *Adwords Editor et Excel:* une étape supplémentaire vers l’accélération des taches routinières
...
[![editor-excel-310x232.png](/images/blog/editor-excel-310x232.png) Fig. 7 Adwords et Editor
