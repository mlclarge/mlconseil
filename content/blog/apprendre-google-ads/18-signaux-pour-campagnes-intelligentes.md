---
title: "18 signaux pour Campagnes Adwords Intelligentes"
date: 2018-03-26
author: "admin"
categories: ["Apprendre Google Ads"]
tags: []
slug: "18-signaux-pour-campagnes-intelligentes"
image: "/images/blog/campagnes-intelligentes-adw.jpg"
---

Après avoir vu deux articles sur les **campagnes intelligentes de Google Adwords** : [structure de campagne](https://www.mauricelargeron.com/6-piliers-campagnes-adwords-intelligentes/) et [benchmark](https://www.mauricelargeron.com/benchmark-google-adwords-machine-learning/) avec ou sans **machine Learning**. Revenons sur les avantages principaux mise en avant par Google pour utiliser au maximum l’intelligence des algorithmes de mise en enchères. C’est plus de 18 signaux au total  qui peuvent être traités d’une manière combinée. J’ai repris la [documentation de Google](https://support.google.com/adwords/answer/7065882) que j’ai segmenté afin  de tenter d’y apporter plus de sens. A l’heure de la RGPD, cela laisse rêveur….sur la collecte des données, mais bon, c’est un autre débat !

## **Rappel -> Optimiser le tunnel de conversion**
...
[![Image](/images/blog/smart-bidding_1-310x149.png)](https://www.mauricelargeron.com/wp-content/uploads/2018/03/smart-bidding_1.png) Tout au long du parcours de conversion actionner des outils Smart
 	...
 	- Stratégie d’enchères automatiques

 	- Mots clés sans restriction

 	- Annonces dynamiques

 	- Extensions automatiques

 	- Landing pages avec valeur ajoutée

 	- Audiences similaires, affinitaires.
...
[![Image](/images/blog/COMPORTEMENTAL-310x179.jpg)](https://www.mauricelargeron.com/wp-content/uploads/2018/03/COMPORTEMENTAL.jpg) Signaux comportementaux
 	...
 	- Comportement des sites (Réseau Display uniquement

## **Message de l’annonceur (1)**
...
[![Image](/images/blog/SPECIFICITE-PAR-CANAL-310x166.jpg)](https://www.mauricelargeron.com/wp-content/uploads/2018/03/SPECIFICITE-PAR-CANAL.jpg) spécificités par canal
 	...
 	- Compétitivité des prix (bientôt disponible)

 	- Saisonnalité (bientôt disponible)

Quant à la mise en œuvre de campagnes Smart, même si parfois certains schémas peuvent simplifier certains concepts,  il n’y a pas de" bouton vert"  sur lequel appuyer pour que cela marche tout seul. Selon les objectifs, les réseaux (search, display, shopping, application), son audience, il faudra utiliser des stratégies d’enchères intelligentes spécifiques. L'occasion de faire fonctionner sa vraie intelligence organique, webmarketing ! Ce sera l’occasion d’un prochain article certainement.