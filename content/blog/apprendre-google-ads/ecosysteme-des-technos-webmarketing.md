---
title: "Puzzle Technologique du Marketing en ligne"
date: 2015-09-14
author: "admin"
categories: ["Apprendre Google Ads"]
tags: []
slug: "ecosysteme-des-technos-webmarketing"
---

**Ecosystème [web marketing](https://fr.wikipedia.org/wiki/Webmarketing)**  vaste sujet ! je vais essayer de le prendre par le bon bout ou par un des bons bouts !  Je suppose en effet qu’il n’y a pas une façon unique de considérer le sujet :)  La représentation de l'ensemble des briques techniques du web marketing fait toujours couler beaucoup d'encre..numérique parfois. Quelles sont donc ces pièces qui assemblées, peuvent former un puzzle cohérent ?   8 principales parties ont été retenues.  Tour d’horizon de ce puzzle e-marketing sous forme de pièces imbriquées (ok rien d’original dans le design :) ), rien n'est exhaustif bien sûr...

## **Tentatives de représentation technique du web marketing**
...
## **Une façon de se représenter l’écosystème WebMarketing**

Du coup, un redécoupage plus cohérent s’impose pour faire du lien entre le côté matériel IT (infrastructure, middleware) et techniques, applications dédiées au  marketing (plateformes, sofware). Cela peut donner cet itinéraire en **8 étapes** :
...
**Mots clés Stratégie et management**
	...
	- Collaborative (gestion de projet)

	- Gestion des canaux de vente (filiales, agences)
...
Bien d’autres services middleware sont à l’œuvre comme dans le M2m (machine to machine) afin d’apporter services, synchronisation, sécurisation dans un monde ultra connecté.

**Solutions, plateformes :** Informatica, Talend, Data migrator (etl), Mashape, Atlas, adserverPub, Dataxu, Adperf Suite, value click (adservers), zappier (connecteurs)
...
Cette pièce est maitresse dans l’écosystème, elle permet de juger des performances ou des défaillances de la stratégie marketing en place. Elle permet ensuite d’ optimiser l’ensemble des leviers . Les applications sont nombreuses, difficile parfois de s’y retrouver !
	...
	- **Test Optimisation (A/B : a/b tasty)**

	- **Attribution (roi : mazeberry)**

	- **Monitoring (uptime, sécurité)**

	- **Audience (visiteurs..)**

	- **Call analytics (parsers)**

	- **Visualisation Reporting (cartes de chaleur)**

	- **Big Data (science of data, analyse de sentiments)**
...
## **Liens **
	...
	- **Chiefmartec Map : **[http://bit.ly/EcosystemTechnologiqueChiefMartec](http://bit.ly/EcosystemTechnologiqueChiefMartec)