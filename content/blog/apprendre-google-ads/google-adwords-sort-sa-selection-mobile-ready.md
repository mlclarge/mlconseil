---
title: "Google Adwords sort sa sélection mobile ready !"
date: 2018-05-07
author: "admin"
...
## **Un nouvel outil : YouTube Reach Planner**
...
[![reach-planner-310x150.jpg](/images/blog/reach-planner-310x150.jpg) Reach planner pour campagnes vidéos

 	- Portée (reach) sur l’audience cible selon le budget et préférences

 	- Fréquence de diffusion et nombre d’impressions selon les critères choisis

 	- Recommandations  automatique de formats publicitaires YouTube les plus optimisés pour l’atteinte de leurs objectifs. C’est un produit disponible via un chargé de compte Google donc il faut avoir un compte « pro » pour en bénéficier pour l’instant, sous-entendu du volume de clics sous le coude pour l’utiliser.

## **Les nouveaux formats déployés**

**True view for reach** sort de la bêta, au CPM, donc pour arroser largement. Les annonces durent 15 à 20 secondes sur mobile, skippable (pouvoir passer l’annonce pour le visiteur).

 

[![true-view-video-1-310x155.jpg](/images/blog/true-view-video-1-310x155.jpg) True view video au CPM

**Nouvelle campagne Outstream !**

**La mise en place est simplissime, choisir sa vidéo à promouvoir, un logo et une description.**

[![video-outstream-310x218.jpg](/images/blog/video-outstream-310x218.jpg) Création campagne video outstream
...
*Dixit Google : Les vidéos outstream sont des annonces diffusées sur **mobile exclusivement**. Elles apparaissent sur les sites et applications partenaires autres que YouTube. **Dès que l'annonce apparaît à l'écran, la lecture démarre automatiquement avec le son coupé. Les utilisateurs peuvent activer le son en appuyant sur la vidéo. Ils peuvent également ignorer l'annonce explicitement où en faisant défiler l'écran*.
 	...
 	- Les annonces outstream vous sont facturées sur la base du coût pour mille impressions visibles (vCPM). Vous ne payez que si votre annonce est visible.

 	- Une annonce est comptabilisée comme "visible" lorsque 50 % de l'espace publicitaire est visible à l'écran et que la vidéo est lue en continu pendant au moins deux secondes.

Plus d’informations ici : https://support.google.com/adwords/answer/7665147
## **Les nouvelles fonctionnalités à venir (en format bêta)**

En cours de test actuellement sur certains comptes ou partiellement déployé.

**Recherche : RSA et Responsivité**
...
[![carousels-ads-google-adwords-310x164.jpg](/images/blog/carousels-ads-google-adwords-310x164.jpg) Carrousel pour le search !
...
[![carousel-format-pour-le-GDN-310x159.jpg](/images/blog/carousel-format-pour-le-GDN-310x159.jpg) Carrousel format pour le GDN
