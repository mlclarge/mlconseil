---
title: "Qu'englobe le terme de \"Publisher\" chez google ?"
date: 2014-01-22
author: "admin"
categories: ["Référencement naturel"]
tags: []
slug: "publisher-et-authorship-lequel-choisir"
---

Je vais essayer d’apporter un peu de clarté à la notion de **publisher ** traduit  en français par  "**éditeur**"   tel que le conçoit Google aujourd’hui. J'avais déjà pu parler dans un précédent post de l'auteurship qui lui est lié et utile en seo. En effet, il circule des informations ici et là en ce moment, tant il est vrai que Google essaie de promouvoir son modèle qu'il soit **publicitaire** (Google Adwords et Adsense) ou  **social** (Google plus). L’actualité en veut pour  preuve   cette  création d’un plugin dédié, dit  "publisher"  pour le  CMS WordPress par la maison Californienne ! Une première du genre….j'en parle en bas de  l'article dans le dernier paragraphe .

## Dans quel cadre utilise t-on le terme publisher ?

### Un complément au sacro-saint authorship…

La **balise rel=author est dédiée au profil Google plus**. Je rappelle que si  l’on souhaite, en tant qu’auteur signer ces œuvres çà et là, Google vous invite fortement à vous authentifier et à relier une page où vous écrivez avec votre profil social.  Cela donne ceci ensuite dans les résultats de recherche du moteur, ou  Google donnerait, semblerait-il, pour résumer,  un signal « + » sur des sources provenant d’auteurs vérifiés.  L’intérêt vis-à-vis de G. est aussi de **capitaliser la création de contenus**  et de rendre à césar ce qui lui appartient en cas de conflit au sein d’organisations (cas d’école : **rédacteur web**).
...
[![rel-authhor-310x244.jpg](/images/blog/rel-authhor-310x244.jpg) Serp Google Auteur
...
Donc le truc technique est de relier son site corporate, à la page Google plus :

Exemple : [rel="publisher**">Me trouver sur Google+](https://plus.google.com/yourpageID)

	- Utile pour une visibilité locale dans Google + local

	- Une façon de montrer une marque avec des visuels riches (vidéos, photos)

	- Les followers s’il y en a ! L

	- Les derniers ajouts sur la page

	- L’opportunité de « suivre » la page G+ si on est logué

	- Une liaison facilitée avec le Knowledge Graph
...
[![gogle-plus-serp-brand-310x242.jpg](/images/blog/gogle-plus-serp-brand-310x242.jpg) Résultat "Publisher" G.
...
[![google-serp-gplus-310x137.jpg](/images/blog/google-serp-gplus-310x137.jpg) Remontée pub. P G+ et Auteur
...
[![plugins-publisher-slots-235x300.jpg](/images/blog/plugins-publisher-slots-235x300.jpg) Emplacements proposés "live" d
...
## Petite revue de ressources sur le web 

	- Lecture des snippets authorship : [http://www.tendances-webmarketing.com/2014/01/knowledge-graph-authorship-google-plus.html](http://www.tendances-webmarketing.com/2014/01/knowledge-graph-authorship-google-plus.html)

	- Intégration  technique pour balise rel=pub : [https://support.google.com/webmasters/answer/1708844?](https://support.google.com/webmasters/answer/1708844?)

	- Implémentation de l'authorship : [https://support.google.com/webmasters/answer/2539557?hl=en](https://support.google.com/webmasters/answer/2539557?hl=en)

	- Sur le plugin Wordpress : [http://wordpress.org/plugins/google-publisher/](http://wordpress.org/plugins/google-publisher/)