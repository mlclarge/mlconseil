---
title: "Référencement d'une vidéo sur internet"
date: 2012-08-07
author: "admin"
categories: ["Référencement naturel"]
tags: []
slug: "22-criteres-seo-pour-referencer-une-video-sur-le-net"
---
...
[![1-classement-top-280x300.png](/images/blog/1-classement-top-280x300.png) Fig. 1 Classement des plateformes vidéos
...
[http://youtu.be/yvinbpRQQWk](http://youtu.be/yvinbpRQQWk)
...
*[(cliquer pour télécharger)](http://www.youtube.com/yt/creators/fr/playbook.html)*
...
[![3-formats-annonces-videos-300x216.png](/images/blog/3-formats-annonces-videos-300x216.png) Fig.3 Onze  formats d'annonces vidéos
...
Le principe du référencement pour une vidéo, reste le même que pour tout autre contenu. Observer les tendances du moment. Selon les mots clés ciblés, une recherche devra s’effectuer sur le potentiel d’audience pouvant être atteint. Youtube communique à ce sujet : [http://www.youtube.com/videos](http://www.youtube.com/videos) .
	...
	- Fournir le contenu vidéo de son site à Google sous forme de** fichier xml** dans [google webmaster tool](https://www.google.com/webmasters/tools/).

Il suffit pour cela de suivre ces indications : [création d’un sitemap pour vidéos](https://support.google.com/webmasters/bin/answer.py?hl=fr&answer=80472) (lister son url, pointer la miniature, le titre, sa description, la durée..)
...
[![5-allocation-video-google-300x244.png](/images/blog/5-allocation-video-google-300x244.png) Fig. 5  Allocations par Google de plateformes vidéo
...
- **Titre **: Soignez sa longueur avec le mot clé directeur- **Description** : Ecrire et ne pas bourrer de mots clés !- **Tag** : Mots clés directeurs (2 maxi, de 2/3 mots en longueur).- **Catégorie** (15)  : veiller à une réelle adéquation avec le sujet.

	- Utiliser les **RichSnippet** *(schema.org)* ?

Je n’ai pas remarqué que Google accorde un satisfecit particulier dans ses résultats pour un contenu vidéo optant pour un formatage sémantique avancé. Sachez néanmoins que cela est prévu dans le standard du schema.org ([videoObject](http://googlewebmastercentral.blogspot.fr/2012/02/using-schemaorg-markup-for-videos.html))
...
### **Recherche de mots clés **
	...
	- Un vieil outil qui peut être utile sur YT : [https://ads.youtube.com/keyword_tool](https://ads.youtube.com/keyword_tool)

### **Création pure**

	- Youtube ! Il est possible avec une simple webcam de créer sa vidéo en ligne : [http://www.youtube.com/my_videos_upload](http://www.youtube.com/my_videos_upload)

	- Plateforme en ligne : [http://animoto.com./](http://animoto.com./)

	- Camtasia (faire des didactiels, montage..) : [http://www.techsmith.fr/camtasia.asp](http://www.techsmith.fr/camtasia.asp)

### **Sous titrage en ligne **

	- Application Saas de sous titrage de vidéos : [http://captiontube.appspot.com/](http://captiontube.appspot.com/)
...
[![6-analytics-video-279x300.png](/images/blog/6-analytics-video-279x300.png) Fig. 6 Suivi statistiques et analytics dans Youtube
