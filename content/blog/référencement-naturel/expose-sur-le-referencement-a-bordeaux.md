...
Pour  e-commerce
 	...
 	- Utiliser le balisage à l’aide de rich snippets

 	- Veiller à une bonne pagination *(1 page pour tout et usage liens html [http://googlewebmastercentral.blogspot.fr/2011/09/pagination-with-relnext-and-relprev.html](http://googlewebmastercentral.blogspot.fr/2011/09/pagination-with-relnext-and-relprev.html) )*
...
Multilingues
 	...
 	- Ne pas  oublier les préconisations Google en ce domaine *([http://googlewebmastercentral.blogspot.fr/2011/12/new-markup-for-multilingual-content.html](http://googlewebmastercentral.blogspot.fr/2011/12/new-markup-for-multilingual-content.html) )*
...
[ Slides et script complets de l'intervention de Y. G ](http://www.slideshare.net/shumisha/rfrencement-aquinum-bordeaux-juillet-2012)
## Netlinking
...
Bref historique de l’algorithme du  Page Rank de Google,  son fonctionnement et le WWW.
 	...
 	- Fondateurs Larry page et Serguey Brin * ([historique Google](http://fr.wikipedia.org/wiki/Google))*

 	- Issu d’un modèle ancien *(matrice stochastique, chaîne de Markov)*

 	- [Théorie de graphes](http://fr.wikipedia.org/wiki/Th%C3%A9orie_des_graphes)* (Nœud = document et Arcs = liens)*
...
Cette séance fut terminée par une série de questions ouvertes, voici  celles que j’ai pu relever :
 	...
 	- Question : Faut-il privilégier l’auteur ou son contenu ?  Les balises d’auteur et les richsnippet  peuvent renforcer l’influence de l’auteur et mettre en avant son contenu. Elargissement du débat sur le [knowledge Graph](http://www.google.com/insidesearch/features/search/knowledge.html) préconisé par Google *(réponse directe à une question)*
