---
title: "Liens sponsorisés ou organiques un vainqueur ?"
date: 2012-08-15
author: "admin"
categories: ["Référencement naturel"]
tags: []
slug: "seo-et-cpc-modeles-de-visibilite-pour-assurer-sa-visibilite-sur-le-net"
---

Je profite de l'article de Lary Kim *(fondateur de WordStream)*  pour faire le point sur l’[impact des liens sponsorisés](http://www.wordstream.com/blog/ws/2012/07/17/google-advertising) sur le référencement naturel, cela complète ainsi le sujet déjà abordé sur [la cannibalisation du marché CPC](https://www.mauricelargeron.com/lien-referencement-payant-et-referencement-organique/) où le propos traduit était  celui de Google. Cette fois-ci,  l’angle d’attaque est celui d’un acteur  "Wordstream"  spécialisé dans l’optimisation des campagnes publicitaire en service cloud. C’est l’occasion aussi de faire  un point sur les **formats d’annonces Adwords** disponibles ou en préparation *(bêta, test)*.
...
[![1-etudeWordstream-300x187.png](/images/blog/1-etudeWordstream-300x187.png)
...
[![2-annoncesProduit-300x142.png](/images/blog/2-annoncesProduit-300x142.png)

	- **Numéro d'appel** pour les téléphones mobiles (fig.3).

[![3-mobileappel.png](/images/blog/3-mobileappel.png)
...
[![4-liensDeSites-300x115.png](/images/blog/4-liensDeSites-300x115.png)

	- **Sociales **Implication des contacts de son réseau * (fig.5) *.

[![5-annoncesSociales-300x56.png](/images/blog/5-annoncesSociales-300x56.png)
...
[![6-liveChat-300x108.png](/images/blog/6-liveChat-300x108.png)

	- ** Champ email** *(déployé aux Us seulement, fig.7)*

[![7-email-300x58.png](/images/blog/7-email-300x58.png)
...
Qui plus est,  cette offensive dans l'innovation publicitaire est doublée d'une guerre déclarée aux [techniques Blackhat](https://www.mauricelargeron.com/populariser-un-site-internet/) de Netlinking *(panda, pingouin)*, aux **sites MFA** (*sur abondance des publicités placés au-dessus de la ligne de flottaison)* et dernièrement aux sites dont les [contenus ne respectent pas le droit d'auteurs](http://insidesearch.blogspot.fr/2012/08/an-update-to-our-search-algorithms.html). Pour finir, Google ne délivre plus des données statistiques sur les mots clés de recherche pour les internautes identifiés ou logués avec l'intitulé '**not provided'**.
[Lary Kim](http://www.wordstream.com/lkim) relance le débat, quel est** le véritable vainqueur : SEM  ou SEO** ?
...
Infos : [Infographie la guerre aux clics gratuits](http://www.wordstream.com/articles/google-ads) *(WordStream)*