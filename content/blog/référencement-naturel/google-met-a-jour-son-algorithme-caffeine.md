---
title: "Google actualise la pertinence de cafféine"
date: 2011-11-04
author: "admin"
categories: ["Référencement naturel"]
tags: []
slug: "google-met-a-jour-son-algorithme-caffeine"
---
...
Google annonce aujourd'hui une mise à jour d'une partie de son **algorithme basé sur caféine** (algo. de l’année dernière). Le moteur de recherche veut mettre l'accent sur la fraîcheur de l'information. Google distingue désormais trois grandes catégories "temporelles" selon le type d'événements.
	...
	- Les événements **récents** ou les sujets chauds du moment (ex : tremblement de terre au japon)

	- les événements** réguliers **(ex : élection  présidentielles)

	- les événements** fréquents **sans être des sujets chauds ou réguliers (ex : avis produit)
