---
title: "Un moteur de recherche Français aux ambitions Européennes"
date: 2017-02-20
author: "admin"
...
https://www.youtube.com/watch?v=2Y9jeCFlU7A
## **Qwant et les autres moteurs de recherche du reste du monde !**
...
## **Qwant et la naissance d’un business**

### ***Une histoire d’entrepreneur autour du marché du search***
...
### *Des clients a aller chercher avec un business modèle classique*

Présent dans 25 pays,  30 millions d’utilisateurs voire un peu plus maintenant, utilisent le moteur. Une belle entreprise donc avec 38 à 40 millions de cash pour se developper en europe avec des particularités culturelles (basque, corse) mais aussi en afrique où tout reste à inventer.

Qwant selon donc E Landri, gagnerait de l’argent avec un modèle économique simple, celui tout simplement d’apporteur d’affaire lors de **clics sur ses résultats de recherche de son moteur shopping**.
...
## **Comment fonctionne Qwant au fait ?**

### *Le web et le live*

Une des tâches les plus rude , c’est la construction de l’index d’un moteur, il faut du temps pour aller récupérer les téras de data que fournissent les réseaux aujourd’hui. Qwant a toujours été conscient de cela, est la construction de son index ne s’est pas fait du jour au lendemain. La technologie de qwant est basé sur une techno déjà existante développée par le société Pertimm éditrice de moteurs de recherche pour des acteurs comme meetic, pages jaunes et Auchan couplé aux dates de moteurs déjà existant. Ce qui lui a valu dès sa naissance , de vives critiques d’observateurs.
...
**Les informations de ce post  sont issues principalement de l’émission SoftPower de Frédéric Martel et du blog de Qwant.*